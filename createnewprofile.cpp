...
void CreateNewProfile::initialize(nvProfilesClass * profClass) const
{
	if (profClass)
	{
...
CreateNewProfile::CreateNewProfile(QWidget *parent) :
    QDialog(parent), bIsProfileCopy(false),
    ui(new Ui::CreateNewProfile)
{
...
/// <summary>
/// Sets the edit enabled flag.
/// </summary>
/// <autogeneratedoc />
/// TODO Edit XML Comment Template for setEditEnabled
void CreateNewProfile::setEditEnabled()
{
...
/// Check the profile.
/// </summary>
void CreateNewProfile::on_pushButton_profileCheck_clicked()
{
    ...
    // does the profile exist.
	 ...
	 if (ptrProf->exists()) // the profile exists
	 {
	  ...
	  QMessageBox::No | QMessageBox::Yes,
		 ...
		 {
			 updateGui("Profile name exists in the eNVy database- overridden");
...
void CreateNewProfile::on_listWidget_doubleClicked(const QModelIndex &index)
{

}

void CreateNewProfile::on_pushButton_Commit_clicked()
{
	QString copiedDescription;
		...
		pClass->setProfileAutoCommitEnabled(ui->checkBox_AutoCommitEnabled->checkState() == Qt::Checked);
		pClass->setProfileNetworkPacketSize(2048);
...
void CreateNewProfile::on_buttonBox_accepted()
{

}

void CreateNewProfile::on_buttonBox_rejected()
{

}

void CreateNewProfile::on_pushButton_Generate_clicked()
{
    ...
    for (int x=0;x< ui->listWidget->count();x++)
    {
        ...
        QString tableName = item->text();
        {
            ...
            QScopedPointer<nvTable> tbl(new nvTable(this));
...
void CreateNewProfile::on_lineEdit_textEdited(const QString &arg1)
{
  ui->lineEdit_ProfileName->setText (arg1.toUpper ());
  this->profileName = arg1;

}

void CreateNewProfile::on_checkBox_ProfileEnabled_stateChanged(int arg1)
{
...
void CreateNewProfile::on_checkBox_AutoCommitEnabled_stateChanged(int arg1)
{
    this->profileAutocommit = (bool) arg1;
}

void CreateNewProfile::on_checkBox_ProfileTraceEnabled_stateChanged(int arg1)
{
    this->profileTrace = (bool) arg1;
}

void CreateNewProfile::on_checkBox_ProfileTransactionLogging_stateChanged(int arg1)
{
    this->profileLoggingEnabled =(bool) arg1;
}

void CreateNewProfile::on_spinBox_CommitThrottle_valueChanged(int arg1)
{
    this->profileCommitThrottle = arg1;
}

void CreateNewProfile::on_spinBox_ExecutionThreads_valueChanged(int arg1)
{
    this->profileExecutionThreads = arg1;
}

void CreateNewProfile::on_textEdit_textChanged()
{
    this->profileDescription = ui->textEdit_description->toPlainText ();
}

void CreateNewProfile::updateGui(QString strMessage)
{
	QString msg;
...
void CreateNewProfile::on_comboBox_loggingLevel_currentIndexChanged(int index)
{
	profileLoggingLevel = index;
}

void CreateNewProfile::on_comboBox_dropTarget_currentIndexChanged(int index)
{
	this->profileTrgDropTarget = index;
}

/// <summary>
/// Ons the push button log file browse clicked.
/// </summary>
/// <autogeneratedoc />
/// TODO Edit XML Comment Template for on_pushButton_LogFileBrowse_clicked
void CreateNewProfile::on_pushButton_LogFileBrowse_clicked()
{
...
void CreateNewProfile::on_lineEdit_LogFileName_textChanged(const QString &arg1)
{
    this->strLogFileName  = arg1;
}

void CreateNewProfile::on_lineEdit_textChanged(const QString &arg1)
{
	arg1.toUpper();
...
void CreateNewProfile::on_pushButton_editProfile_clicked()
{
...
void CreateNewProfile::on_pushButton_deleteProfile_clicked()
{
	auto * pClass = new nvProfilesClass(this);
	pClass->setProfileName(profileName);
	{
...
void CreateNewProfile::on_pushButton_copyProfile_clicked()
{
...
void CreateNewProfile::on_lineEdit_copyProfileName_textChanged(const QString &arg1)
{
